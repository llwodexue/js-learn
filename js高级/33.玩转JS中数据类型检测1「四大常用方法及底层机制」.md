...
- 非普通对象.toString：调用的都是自己所属类原型上的 toString，并不是 Object.prototype.toString，都是转换为字符串
- 普通对象.toString：调用 Object.prototype.toString 这个方法，是检测数据类型
...
- 首先看 `[value][Symbol.toStringTag]`，如果存在这个属性，属性是啥，"?" 就是啥，如果没有这个属性，一般是返回所属类构造函数信息
