...
1. 基本数据类型
   ...
   - null
   - undefined
2. 引用数据类型 - function 函数 - object 对象  
...
![](https://gitee.com/lilyn/pic/raw/master/js-img/%E7%B1%BB%E5%9E%8B%E8%BD%AC%E6%8D%A2.jpg)
...
| Boolean      | 如果布尔值是true，则返回`true`<br/>。否则返回`false`                                                                                 |
| Date         | 返回日期的文本表示                                                                                                                   |
...
| Object(默认) | 返回`[object ObjectName]`<br/>，其中 ObjectName 是对象类型的名称                                                                     |
